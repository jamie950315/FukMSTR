...
btcusdc-v176-combined-state-overlay:
	PYTHONPATH=src python scripts/run_btcusdc_v176_combined_state_overlay.py
...
btcusdc-v178-diversified-overlay:
	PYTHONPATH=src python scripts/run_btcusdc_v178_diversified_overlay.py

test-btcusdc-v178:
	PYTEST_DISABLE_PLUGIN_AUTOLOAD=1 PYTHONPATH=src pytest -q tests/test_btcusdc_v178_diversified_overlay.py

btcusdc-v179-short-nonspike-overlay:
	PYTHONPATH=src python scripts/run_btcusdc_v179_short_nonspike_overlay.py

test-btcusdc-v179:
	PYTEST_DISABLE_PLUGIN_AUTOLOAD=1 PYTHONPATH=src pytest -q tests/test_btcusdc_v179_short_nonspike_overlay.py

btcusdc-v180-short-base-late-day-throttle:
	PYTHONPATH=src python scripts/run_btcusdc_v180_short_base_late_day_throttle.py
...
btcusdc-v182-short-base-momentum-boost:
	PYTHONPATH=src python scripts/run_btcusdc_v182_short_base_momentum_boost.py

test-btcusdc-v182:
	PYTEST_DISABLE_PLUGIN_AUTOLOAD=1 PYTHONPATH=src pytest -q tests/test_btcusdc_v182_short_base_momentum_boost.py

btcusdc-v183-short-base-momentum-stepup:
	PYTHONPATH=src python scripts/run_btcusdc_v183_short_base_momentum_stepup.py
...
btcusdc-v187-drought-long-base-trend-stepup:
	PYTHONPATH=src python scripts/run_btcusdc_v187_drought_long_base_trend_stepup.py
...
btcusdc-v189-rescue-mid-range-extreme-stepup:
	PYTHONPATH=src python scripts/run_btcusdc_v189_rescue_mid_range_extreme_stepup.py
...
btcusdc-v192-long-base-low-probz-throttle:
	PYTHONPATH=src python scripts/run_btcusdc_v192_long_base_low_probz_throttle.py

test-btcusdc-v192:
	PYTEST_DISABLE_PLUGIN_AUTOLOAD=1 PYTHONPATH=src pytest -q tests/test_btcusdc_v192_long_base_low_probz_throttle.py

btcusdc-v193-long-base-top5-premium6h-throttle:
	PYTHONPATH=src python scripts/run_btcusdc_v193_long_base_top5_premium6h_throttle.py
...
btcusdc-v204-real-money-readiness-gate:
	PYTHONPATH=src python scripts/run_btcusdc_v204_real_money_readiness_gate.py

test-btcusdc-v204:
	PYTEST_DISABLE_PLUGIN_AUTOLOAD=1 PYTHONPATH=src pytest -q tests/test_btcusdc_v204_real_money_readiness_gate.py

btcusdc-v205-execution-validation:
...
btcusdc-v211-signal-provenance-gate:
...
test-btcusdc-v213:
	PYTEST_DISABLE_PLUGIN_AUTOLOAD=1 PYTHONPATH=src pytest -q tests/test_btcusdc_v206_real_money_launch_preflight.py tests/test_paper_trading_v142.py::test_real_trade_preflight_blocks_legacy_ready_summary_without_v212 tests/test_paper_trading_v142.py::test_real_trade_btcusdc_cli_blocks_when_v206_preflight_is_not_ready

btcusdc-v214-public-data-availability-gate:
	PYTHONPATH=src python scripts/run_btcusdc_v214_public_data_availability_gate.py
...
test-btcusdc-v216:
	PYTEST_DISABLE_PLUGIN_AUTOLOAD=1 PYTHONPATH=src pytest -q tests/test_btcusdc_v204_real_money_readiness_gate.py tests/test_btcusdc_v205_execution_validation.py tests/test_btcusdc_v209_execution_provenance_gate.py

test-btcusdc-v217:
	PYTEST_DISABLE_PLUGIN_AUTOLOAD=1 PYTHONPATH=src pytest -q tests/test_btcusdc_v206_real_money_launch_preflight.py tests/test_paper_trading_v142.py::test_real_trade_preflight_blocks_ready_summary_without_v216_execution_provenance tests/test_paper_trading_v142.py::test_real_trade_preflight_blocks_ready_summary_without_v214_public_data tests/test_paper_trading_v142.py::test_real_trade_preflight_blocks_legacy_ready_summary_without_v212 tests/test_paper_trading_v142.py::test_real_trade_btcusdc_cli_blocks_when_v206_preflight_is_not_ready

test-btcusdc-v218:
	PYTEST_DISABLE_PLUGIN_AUTOLOAD=1 PYTHONPATH=src pytest -q tests/test_btcusdc_v204_real_money_readiness_gate.py tests/test_btcusdc_v206_real_money_launch_preflight.py tests/test_paper_trading_v142.py::test_real_trade_preflight_blocks_ready_summary_from_different_source_commit tests/test_paper_trading_v142.py::test_real_trade_preflight_blocks_ready_summary_without_v216_execution_provenance tests/test_paper_trading_v142.py::test_real_trade_btcusdc_cli_blocks_when_v206_preflight_is_not_ready

test-btcusdc-v219:
	PYTEST_DISABLE_PLUGIN_AUTOLOAD=1 PYTHONPATH=src pytest -q tests/test_btcusdc_v204_real_money_readiness_gate.py tests/test_btcusdc_v206_real_money_launch_preflight.py tests/test_paper_trading_v142.py::test_real_trade_preflight_blocks_ready_summary_when_input_hash_changes tests/test_paper_trading_v142.py::test_real_trade_preflight_blocks_ready_summary_from_different_source_commit tests/test_paper_trading_v142.py::test_real_trade_preflight_blocks_ready_summary_without_v216_execution_provenance tests/test_paper_trading_v142.py::test_real_trade_btcusdc_cli_blocks_when_v206_preflight_is_not_ready

test-btcusdc-v220:
	PYTEST_DISABLE_PLUGIN_AUTOLOAD=1 PYTHONPATH=src pytest -q tests/test_btcusdc_v204_real_money_readiness_gate.py tests/test_btcusdc_v205_execution_validation.py tests/test_btcusdc_v206_real_money_launch_preflight.py tests/test_paper_trading_v142.py::test_real_trade_preflight_blocks_ready_summary_without_v220_recent_execution_evidence tests/test_paper_trading_v142.py::test_real_trade_preflight_blocks_ready_summary_when_input_hash_changes tests/test_paper_trading_v142.py::test_real_trade_preflight_blocks_ready_summary_from_different_source_commit tests/test_paper_trading_v142.py::test_real_trade_preflight_blocks_ready_summary_without_v216_execution_provenance tests/test_paper_trading_v142.py::test_real_trade_btcusdc_cli_blocks_when_v206_preflight_is_not_ready

test-btcusdc-v221:
	PYTEST_DISABLE_PLUGIN_AUTOLOAD=1 PYTHONPATH=src pytest -q tests/test_btcusdc_v204_real_money_readiness_gate.py tests/test_btcusdc_v206_real_money_launch_preflight.py tests/test_paper_trading_v142.py::test_real_trade_preflight_blocks_ready_summary_from_different_source_commit tests/test_paper_trading_v142.py::test_real_trade_preflight_blocks_ready_summary_when_input_hash_changes tests/test_paper_trading_v142.py::test_real_trade_btcusdc_cli_blocks_when_v206_preflight_is_not_ready

test-btcusdc-v222:
	PYTEST_DISABLE_PLUGIN_AUTOLOAD=1 PYTHONPATH=src pytest -q tests/test_btcusdc_v204_real_money_readiness_gate.py tests/test_btcusdc_v205_execution_validation.py tests/test_btcusdc_v206_real_money_launch_preflight.py tests/test_btcusdc_v209_execution_provenance_gate.py tests/test_btcusdc_v210_paper_shadow_fill_capture.py tests/test_paper_trading_v142.py::test_real_trade_btcusdc_cli_blocks_when_v206_preflight_is_not_ready
