...
if __name__ == "__main__":
    ...
    input_dir = root / "runs" / "research_v36_btcusdc_aggtrade_flow_ytd_rolling_input"
    ...
    result = run_btcusdc_rolling_forward_validation(
        ...
        out_dir=root / "runs" / "research_v36_btcusdc_aggtrade_flow_ytd_rolling",
    ...
    payload = {
        ...
        "out_dir": str(root / "runs" / "research_v36_btcusdc_aggtrade_flow_ytd_rolling"),
        "aggregate": result["aggregate"],
    }
    (input_dir / "aggtrade_flow_ytd_rolling_run_summary.json").write_text(json.dumps(payload, indent=2), encoding="utf-8")
