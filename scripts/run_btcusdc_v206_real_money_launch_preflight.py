...
def _write_report(payload: dict[str, Any]) -> None:
    ...
    lines = [
        ...
        f"| V224 forward-freeze manifest hash present and current | {checks['readiness_forward_freeze_manifest_clean']} | readiness_forward_freeze_manifest_clean={evidence['readiness_forward_freeze_manifest_clean']} |",
