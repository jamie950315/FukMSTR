...
Current active safety state is V222:
...
- V212, V214, V216, V218, V219, V220, V221, and V222 add forward freshness, public data availability, execution/signal provenance, source provenance, input hash, recent execution evidence, runtime source hash, and paper-shadow capture provenance locks.
- As of V222, the real-money path is still blocked until fresh forward evidence and recent execution validation are clean.
